...
with col1:
    ...
    script = st.text_area("Paste your script here:", height=350, placeholder="Write your content...", key="main_script")
    ...
    <div class='guide-box'>
        ...
        • <b>Slow Pace (-5 to -10):</b> Use for Emotional or Thriller stories.<br>
        • <b>Normal Pace (-2 to 0):</b> Use for general Information and Vlogs.
    </div>
    """, unsafe_allow_html=True)
...
with col2:
    ...
    v_pitch = st.slider("Vocal Depth (Heavy/Sharp)", -20, 20, -8)
    v_rate = st.slider("Speech Rate (Speed Control)", -20, 20, -5)
    ...
    st.info("💡 Pro Tip: For World Affairs, use 'Asad' or 'Madhur' with -8 Vocal Depth.")
...
if st.button("🚀 GENERATE PROFESSIONAL PRODUCTION"):
    if not script.strip():
        ...
        try:
            ...
            st.error(f"Technical Alert: {e}")

st.markdown("<p style='text-align: center; color: #BDC1C6; margin-top: 50px;'>Harsh AI Studio | v12.0 Master | 2026</p>", unsafe_allow_html=True)
